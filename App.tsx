...
const AppContent: React.FC = () => {
  ...
  const handleCalculate = useCallback(async () => {
    ...
    try {
      ...
      if (uniquePlaceIds.length === 0) throw new Error("ZERO ENTITIES FOUND IN SECTOR.");
      ...
      if (candidatesForGemini.length === 0) {
        // This should theoretically be unreachable now with the fallback logic, but safety first
