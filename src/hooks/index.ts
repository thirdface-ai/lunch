// Custom hooks for the Lunch Decider application
export { usePreferences, default as usePreferencesDefault } from './usePreferences';
export { useTerminalLogs, default as useTerminalLogsDefault } from './useTerminalLogs';
